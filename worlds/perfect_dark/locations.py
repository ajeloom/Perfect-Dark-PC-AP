...
LOCATION_NAME_TO_ID = {
    ...
    "Complete 18 Challenges: Party Frock, Party (Ripped), Evening Wear, and President Unlock": 564,
        ...
        if world.options.multiplayer_unlocks:
            mp_unlock_locations = get_location_names_with_ids(
                [
                    ...
                    "Complete 18 Challenges: Party Frock, Party (Ripped), Evening Wear, and President Unlock",
